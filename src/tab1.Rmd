...
```{r tab11yr, cache=cacheon, dependson="tab1func"}
tab1func("prevhfhosp1yr", "previous HFH within 1 year")
```
...
tab1func(stratavar = "prevhfhosp_cat", "previous HFH 6 groups", fontsize = 4)
```

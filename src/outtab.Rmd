...
survfunc <- function(time, event, eventcr = NULL, hospvarcr = NULL, eventname, hospvar, rep = FALSE, repevent = NULL) {
  ...
  if (!rep) {
    ...
    ## adjusted covs excluding ntprobnp/bnp
...
out <- survfunc2(hospvar2 = "prevhfhosp1yr", hospvarcr2 = "prevhfhosp1yr_cr_Yes")
...
out <- survfunc2(
  ...
  hospvarcr2 = c(
    "prevhfhosp_cat_cr_HFHunder30d", "prevhfhosp_cat_cr_HFH30m90d",
    "prevhfhosp_cat_cr_HFH90dm6mo", "prevhfhosp_cat_cr_HFH6mom1yr",
    "prevhfhosp_cat_cr_HFHover1yr"
  )
)

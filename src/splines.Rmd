...
mytermplot <- function(mod, xlab = "Time since previous HFH (months)", ylab = "Hazard Ratio (95% CI)",
...
```{r scvdrephfh, fig.cap="Spline CVD/total HFH", cache=cacheon, dependson="splinefunc", fig.width=8, fig.height=7}
splinefunc(
  event = "out_cvdhfh"
)
```
...
```{r srephfh, fig.cap="Spline total HFH", cache=cacheon, dependson="splinefunc", fig.width=8, fig.height=7}
splinefunc(
  event = "out_hfh"
)
```

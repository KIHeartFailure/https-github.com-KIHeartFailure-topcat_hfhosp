...
kmfunc <- function(data, time, event, eventname, eventrec, hospvar, yposplus = rep(0.03, 2)) {
  ...
  if (nlevsh == 2) {
    ...
    text(y = 0.9, x = 1.5, "Adj HR (95% CI), p-value", cex = cexmy, adj = 0.5)
  ...
  if (nlevsh == 7) {
    ...
    text(x = 2.905, 0.96, "Adj HR (95% CI), p", cex = cexmy)
...
mcffunc <- function(eventname, event, hospvar, yposplus = rep(0.05, 2)) {
  ...
  if (nlevsh == 2) {
    ypos <- c(
      last(fits@MCF$MCF[fits@MCF$time <= 4 & fits@MCF[hospvar] == levsh[1]]),
      last(fits@MCF$MCF[fits@MCF$time <= 4 & fits@MCF[hospvar] == levsh[2]])
    )
    ...
    text(y = 2 * 0.9, x = 1.5, "Adj HR (95% CI), p-value", cex = cexmy, adj = 0.5)
  ...
  if (nlevsh == 7) {
    ...
    text(x = 2.905, 0.96 * 2, "Adj HR (95% CI), p", cex = cexmy)

...
```{r cvdrephfh, fig.cap="CVD/total HFH", cache=cacheon, dependson="mcffunc", fig.width=9, fig.height=7}
mcffunc(
  time = "outtime_cvd",
  event = "out_cvd",
...
```{r rephfh, fig.cap="Total HFH", cache=cacheon, dependson="mcffunc", fig.width=9, fig.height=7}
mcffunc(
  time = "outtime_cvd",
  event = "out_cvd",
  eventname = "total HFH",
